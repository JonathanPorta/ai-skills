...
help: ## List available commands
	@printf '%s\n' \
		...
		'make integration-open-design  Verify pinned Open Design discovery and staging'
...
integration-open-design: ## Verify exact Open Design production discovery in OPEN_DESIGN_REPO
