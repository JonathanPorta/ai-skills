...
help: ## List available commands
	@printf '%s\n' \
		...
		'make integration-open-design  Verify pinned Open Design plugin loading and staging'
...
integration-open-design: ## Verify exact Open Design plugin loading in OPEN_DESIGN_REPO
